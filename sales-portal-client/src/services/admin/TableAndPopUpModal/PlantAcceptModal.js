...
function PlantAcceptModal(props) {
    return (
        <div>
            <Modal title="Accept Request " visible={!!props.isAcceptModalVisible}
                ...
                <form>
                    ...
                    <div className="comment-btn">
                        <button type="button" className="sbmt-btn"
                            ...
                            onCancel={props.hideModalAcceptAndReject} onClick={() => { props.handleUpdateRequest("APPROVED") }}  >
                            Submit
                        </button>
                    </div>
                </form>
...
export default PlantAcceptModal
