...
configuration.s3 = {
    ...
    forecastDownloadPath: process.env.FORECAST_DONWLOAD_S3_FOLDER_PATH + '/prod',
    forecastUploadPath: process.env.FORECAST_UPLOAD_S3_FOLDER_PATH + '/prod',
    forecastArchivePath: process.env.FORECAST_ARCHIVE_S3_FOLDER_PATH + '/prod',
