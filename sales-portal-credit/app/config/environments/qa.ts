...
configuration.s3 = {
    ...
    creditLimitS3Path: process.env.CREDIT_LIMIT_S3_FOLDER_PATH + '/uat',
    creditLimitBaseLimitS3Path: process.env.CREDIT_LIMIT_BASELIMIT_UPLOAD_S3_FOLDER_PATH + '/uat',
    urlTimeout: process.env.S3_URL_TIMEOUT,
    creditLimitGTExcelS3Path: process.env.CREDIT_LIMIT_GT_S3_EXCEL_FOLDER_PATH + '/uat',
};
